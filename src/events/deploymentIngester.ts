import { Ingester, ingester, type } from "@atomist/automation-client/ingesters";

export const DeploymentEvent: Ingester = ingester("DeploymentEvent")
...
.withType(type("Deployment")
 ...
 .withType(type("DeploymentEvent")
    ...
    .withObjectField("sender", "Principal", "sender of the deployment event", ["login", "type"])).build();
